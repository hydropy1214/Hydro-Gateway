...
public final class ConfigDao_Impl implements ConfigDao {
  ...
  public ConfigDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__preparedStmtOfDelete = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "DELETE FROM config WHERE key = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object set(final Config config, final Continuation<? super Unit> arg1) {
  ...
  @Override
  public Object delete(final String key, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Object get(final String key, final Continuation<? super String> arg1) {
    final String _sql = "SELECT value FROM config WHERE key = ?";
